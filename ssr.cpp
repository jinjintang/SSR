...
public:
	...
	void prepareOffscreenFramebuffers()
	{
		...
		// G-Buffer 
		createAttachment(VK_FORMAT_R8G8B8A8_UNORM, VK_IMAGE_USAGE_COLOR_ATTACHMENT_BIT, &frameBuffers.offscreen.color, width, height);			// Normals
		...
		// ssr
		createAttachment(VK_FORMAT_R32G32B32A32_UINT, VK_IMAGE_USAGE_COLOR_ATTACHMENT_BIT, &frameBuffers.ssr.color, ssrWidth, ssrHeight);				// Color
		createAttachment(VK_FORMAT_R8G8B8A8_UNORM, VK_IMAGE_USAGE_COLOR_ATTACHMENT_BIT, &frameBuffers.temprol.color[0], ssrWidth, ssrHeight);				// Color
		createAttachment(VK_FORMAT_R8G8B8A8_UNORM, VK_IMAGE_USAGE_COLOR_ATTACHMENT_BIT, &frameBuffers.temprol.color[1], ssrWidth, ssrHeight);				// Color

		createAttachment(VK_FORMAT_R8G8B8A8_UNORM, VK_IMAGE_USAGE_COLOR_ATTACHMENT_BIT, &frameBuffers.rayCast.rayCast, width, height);					// Color
		createAttachment(VK_FORMAT_R8G8B8A8_UNORM, VK_IMAGE_USAGE_COLOR_ATTACHMENT_BIT, &frameBuffers.rayCast.rayCastMask, width, height);					// Color
	...
	void updateDescriptorSet() {
		...
		imageDescriptors = {
			...
			vks::initializers::descriptorImageInfo(colorSampler, frameBuffers.offscreen.depth.view, VK_IMAGE_LAYOUT_SHADER_READ_ONLY_OPTIMAL),
			vks::initializers::descriptorImageInfo(colorSampler, frameBuffers.rayCast.rayCast.view, VK_IMAGE_LAYOUT_SHADER_READ_ONLY_OPTIMAL),
			vks::initializers::descriptorImageInfo(colorSampler, frameBuffers.offscreen.color.view, VK_IMAGE_LAYOUT_SHADER_READ_ONLY_OPTIMAL),
			vks::initializers::descriptorImageInfo(colorSampler, frameBuffers.rayCast.rayCastMask.view, VK_IMAGE_LAYOUT_SHADER_READ_ONLY_OPTIMAL),
			vks::initializers::descriptorImageInfo(colorSampler, frameBuffers.ssr.color.view, VK_IMAGE_LAYOUT_SHADER_READ_ONLY_OPTIMAL),
			vks::initializers::descriptorImageInfo(colorSampler, frameBuffers.temprol.color[current].view, VK_IMAGE_LAYOUT_SHADER_READ_ONLY_OPTIMAL),
			vks::initializers::descriptorImageInfo(colorSampler, frameBuffers.temprol.color[1-current].view, VK_IMAGE_LAYOUT_SHADER_READ_ONLY_OPTIMAL),
...
//		glm::vec3 modelRotation = glm::vec3(180.0f);
	...
	void updateUniformBufferTemprolParams()
	{
		...
		uboTemprolParams._FeedbackMin_Max_Mscale = glm::vec4(0.88f, 0.97f, 0.0f, 0.0f);
